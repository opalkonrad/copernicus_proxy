filters = [["altimeter_range_relative_correction", "Altimeter range relative correction"],
           ...
           ["convective_inhibition", "Convective inhibition"], ["duct_base_height", "Duct base height"],
           ...
           ["forecast_albedo", "Forecast albedo"], ["forecast_surface_roughness", "Forecast surface roughness"],
           ...
           ["k_index", "K index"], ["land_sea_mask", "Land sea mask"],
           ...
           ["northward_turbulent_surface_stress", "Northward turbulent surface stress"], ["orography", "Orography"],
           ["sea_ice_cover", "Sea ice cover"], ["skin_reservoir_content", "Skin reservoir content"],
           ...
           ["v_component_stokes_drift", "V component stokes drift"], ["zero_degree_level", "Zero degree level"]]
