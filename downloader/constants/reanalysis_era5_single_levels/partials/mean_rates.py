filters = [["mean_boundary_layer_dissipation", "Mean boundary layer dissipation"],
           ...
           ["mean_runoff_rate", "Mean runoff rate"], ["mean_snow_evaporation_rate", "Mean snow evaporation rate"],
