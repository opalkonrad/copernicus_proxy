...
from downloader.constants.reanalysis_era5_single_levels import popular, temperature_and_pressure
...
temperature_and_pressure_filters = tuple(temperature_and_pressure.filters)
